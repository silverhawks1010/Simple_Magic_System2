-- The total number of magic it can have.
SMS_Config.MaxPower = 1
-- The default number of manas when creating the character.
SMS_Config.DefaultMana = 700
-- Number of mana earn per minute.
SMS_Config.ManaPerMinutes = 1
